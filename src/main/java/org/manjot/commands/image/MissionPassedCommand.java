...
public class MissionPassedCommand extends Command implements CommandListener {

    public MissionPassedCommand() {
        this.setName("missionpassed")
                .setAliases("respect")
                .setDescription("Add mission-passed filter to a user avatar")
                .setUsage("missionpassed (@user)")
