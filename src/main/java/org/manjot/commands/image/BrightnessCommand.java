...
public class BrightnessCommand extends Command implements CommandListener {

    public BrightnessCommand() {
        this.setName("brightness")
                .setAliases("bright")
                .setDescription("Add brightness filter to a user avatar")
                .setUsage("brightness (@user)")
