...
public class ForwardCommand extends Command implements CommandListener {

    public ForwardCommand() {
        this.setName("forward")
                .setAliases("fwd", "forwards")
                .setDescription("Move forward in music")
                .setUsage("forward (seconds)")
    ...
    public void onCommand(JDA jda, MessageReceivedEvent event, User author, Member member, Guild guild,
        ...
        if (audioTrack.getInfo().isStream) {
            Error.replyMessage(message, "Cannot move forward in a live stream");
            return;
        }
        ...
        message.replyEmbeds(
                embed.setTitle("Forward")
                        .appendDescription("Moved forward " + skipSeconds + " seconds...")
